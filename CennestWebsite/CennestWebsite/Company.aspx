            ...
            <div class="span12" id="divMain">
                ...
                <div class="camera_full_width">
                    <div id="camera_wrap" class="shadow">
                        <div data-src="slider-images/Company1.jpg">
                            <div class="camera_caption fadeFromBottom cap1">Team Work</div>
                        </div>
                        <div data-src="slider-images/Company2.jpg">
                            <div class="camera_caption fadeFromBottom cap1">Cennest Fun Time!</div>
                        </div>
                        <div data-src="slider-images/Company3.jpg">
                            <div class="camera_caption fadeFromBottom cap1">Christamas Celebration</div>
                        </div>
                        <div data-src="slider-images/Company4.jpg">
                            <div class="camera_caption fadeFromBottom cap1">Our Office</div>
                        </div>
                        <div data-src="slider-images/Company5.jpg">
                            <div class="camera_caption fadeFromBottom cap1">Diwali at Cennest</div>
                        </div>
                        <div data-src="slider-images/Company6.jpg">
                            <div class="camera_caption fadeFromBottom cap1">Our Team</div>
                        </div>
                        <div data-src="slider-images/Company7.jpg">
                            <div class="camera_caption fadeFromBottom cap1">A visit to National Association For Blinds</div>
                        </div>
                    </div>
                    <br style="clear: both" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script type="text/javascript">
        ...
        function startCamera() { $('#camera_wrap').camera({ fx: 'simpleFade, mosaicSpiralReverse', time: 2000, loader: 'none', playPause: false, navigation: true, height: '38%', pagination: true }); } $(function () { startCamera() });
    </script>
